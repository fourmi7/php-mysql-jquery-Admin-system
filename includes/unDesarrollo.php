<?php 
  ...
  if (isset($_POST['deleteR'])) {
    $relevante_id = $_POST['relevante_id'];
    $response = $getFromD->deleteRelevante($relevante_id);
    if ($response == "ok") {
      echo '<script>
        swal({
          title : "¡Ok!",
  ...
  if (isset($_POST['editRelevante'])) {
    ...
    if (empty($cantidad)) {
      ...
      $result = $getFromD->updateRelevante($relevante_id, $cantidad, $descripcion);
      if ($result == "ok") {
        echo '<script>
          swal({
            title : "¡Ok!",
...
if(isset($_GET['d']) ) {
  include ("includes/setDesarrollo.php");
        ...
        <table class="table table-bordered table-hover">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><img src="<?php echo BASE_URL.'Fotos/'. $des->foto_portada; ?>" width="50" height="50"></td>
            </tr>
            <tr>
              <th>Imagen de Section</th>
              <td><img src="<?php echo BASE_URL.'Fotos/'. $des->foto_section; ?>" width="50" height="50"></td>
            </tr>
            <tr>
    ...
    <div class="card card-dark">
      <div class="card-header">
        <h3 class="card-title">Especificacion del Desarrollo
          <?php if (empty($esp->id)) {?>
    ...
    <div class="card card-dark">
      <div class="card-header">
        <h3 class="card-title">Información principal del inmueble
        <a href="#" data-toggle="modal" class="text-white" data-target="#relevantes-<?php echo $des->id ; ?>"><button class="float-right btn btn-primary">Agregar&nbsp; <i class="fa fa-plus"></i></button></a>
      </h3>
      </div>
      <!-- /.card-header -->
      <div class="card-body">
        <table class="table table-bordered table-hover">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="#" data-toggle="modal"  data-target="#relev-<?php echo $r->id ; ?>"><button class="btn btn-warning "><i class="fa fa-pencil"></i></button></a>
                <div class="float-right">
                  <form action="" method="post">
                    <input type="hidden" name="relevante_id" value="<?php echo $r->id ; ?>">
                    <button class="fa fa-times btn btn-danger" type="submit" name="deleteR"></button>
                  </form>
                </div>
              </td>
            </tr>
            ...
            <div class="modal fade" id="relev-<?php echo $r->id; ?>" role="dialog" tabindex="-1">
              <div class="modal-dialog">
                <div class="modal-content card card-warning">
                  <div class="modal-header card-header">
                    <h5 class="text-center" >Modificar Informacion </h5>
                  ...
                  <div class="modal-body">
                    <form method="post" >
                      <div class="form-group">
                        ...
                        <input type="text" name="cantidad" class="form-control"  value="<?php echo $r->cantidad ?>">
                      </div>
                      <div class="form-group">
                        <label for="email">Descripcion </label>
                        <input type="text" name="descripcion" class="form-control" value="<?php echo $r->descripcion ?>">
                      </div>
                      <div class="form-group">
                        <input type="hidden" name="relevante_id" value="<?php echo $r->id; ?>" class="form-control">
                      </div>
                      <div class="card-footer">
                        <button type="submit" name="editRelevante" class="btn btn-block btn-primary">Guardar</button>
                      </div>
                    </form>
                  </div>
                </div> 
    ...
    <?php include "addRelevanteModal.php"; ?>
    <!-- Caracteristica -->
    <div class="card card-dark">
      <div class="card-header">
        <h3 class="card-title">Caracteristicas del Desarrollo
    ...
    <div class="card card-dark">
      <div class="card-header">
        <h3 class="card-title">
        	Imagen Planta y Pdf del Desarrollo
