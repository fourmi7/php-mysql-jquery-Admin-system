<?php 
    ...
    class Desarrollo
    {
        ...
        public function registrarDesarrollo($idcategoria, $idsubcategoria, $direccion, $precio_por_metro, $descripcion, $latitud, $longitud, $detalle_de_entrega)
        {
            $stmt = $this->pdo->prepare("INSERT INTO `desarrollos` ( `idcategoria`, `idsubcategoria`, `direccion`, `precio_por_metro`, `descripcion`, `latitud`, `longitud`, `detalle_de_entrega` ) VALUES(:idcategoria, :idsubcategoria, :direccion, :precio_por_metro, :descripcion, :latitud, :longitud, :detalle_de_entrega )");  
        ...
        public function updateDesarrollo($id, $idcategoria, $idsubcategoria, $direccion, $precio_por_metro, $descripcion, $latitud, $longitud, $detalle_de_entrega)
        {
            $stmt = $this->pdo->prepare(
                "UPDATE desarrollos SET idcategoria = :idcategoria, idsubcategoria = :idsubcategoria, direccion = :direccion, precio_por_metro = :precio_por_metro, descripcion = :descripcion, latitud = :latitud, longitud = :longitud, detalle_de_entrega = :detalle_de_entrega WHERE id = :id ");
